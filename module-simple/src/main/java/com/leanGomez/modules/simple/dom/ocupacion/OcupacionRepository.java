...
@DomainService(nature = NatureOfService.DOMAIN, repositoryFor = Ocupacion.class)
public class OcupacionRepository {
	...
	public List<Ocupacion> buscarPorNombre(final String ocupacionNombre) {
		return repositoryService.allMatches(new QueryDefault<>(Ocupacion.class, "buscarPorNombre", "ocupacionNombre",
				ocupacionNombre.toLowerCase()));
	}

	public List<Ocupacion> listarActivos() {
		return repositoryService.allMatches(new QueryDefault<>(Ocupacion.class, "listarActivos"));
	}

	public List<Ocupacion> listarInactivos() {
		return repositoryService.allMatches(new QueryDefault<>(Ocupacion.class, "listarInactivos"));
	}
